...
public class FormDataPembelian extends javax.swing.JInternalFrame {
    ...
    private void TxtKodeBarCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_TxtKodeBarCaretUpdate
        ...
        try {            
            ...
            String sql="Select * from barang where kode_Barang='" + this.TxtKodeBar.getText() + "'";
            ResultSet r=s.executeQuery(sql);
           while (r.next()){
                this.LabelNamaBarang.setText(r.getString("Nama_Barang"));              
                this.LabelHargaJual.setText(r.getString("Harga_Jual")); 
                this.LabelHargaBeli.setText(r.getString("Harga_Beli")); 
                this.LabelTotalStok.setText(r.getString("Stok_Barang")); 
            }
            r.close();
            s.close();
