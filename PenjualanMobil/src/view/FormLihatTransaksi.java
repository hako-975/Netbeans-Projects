 ...
 */
public class FormLihatTransaksi extends javax.swing.JDialog {
    private final DefaultTableModel transaksiTableModel;
    private String kodeTransaksiDipilih;
    
    /**
     * Creates new form FormLihatAdmin
     */
    public FormLihatTransaksi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        transaksiTableModel = (DefaultTableModel) transaksiTable.getModel();
    }
    ...
    private void initComponents() {
        ...
        transaksiTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Transaksi", "Tgl Transaksi", "NIK Pembeli", "Kode Mobil", "Kode Admin", "Bayar"
            }
        ) {
    ...
    public void tampilkanData(Object[][] list) {
        ...
        if ((list != null) && (list.length > 0)) {
            for (int i = 0; i < list.length; i++) {
                transaksiTableModel.addRow(list[i]);
            }
        }
    }
    
    public String getKodeTransaksiDipilih() {
        return kodeTransaksiDipilih;
    }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // TODO add your handling code here:
        kodeTransaksiDipilih = "";
    }//GEN-LAST:event_formWindowActivated

    private void pilihButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihButtonActionPerformed
        // TODO add your handling code here:
        if (transaksiTable.getSelectedRowCount() > 0) {
            kodeTransaksiDipilih = transaksiTable.getValueAt(
                    transaksiTable.getSelectedRow(), 0).toString();
            dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormLihatTransaksi dialog = new FormLihatTransaksi(new javax.swing.JFrame(), true);
